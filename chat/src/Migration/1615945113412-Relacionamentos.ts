...
export class Relacionamentos1615945113412 implements MigrationInterface {
    name = 'Relacionamentos1615945113412'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "order_item" ("id" uniqueidentifier NOT NULL CONSTRAINT "DF_d01158fe15b1ead5c26fd7f4e90" DEFAULT NEWSEQUENTIALID(), "createad_at" datetime2 NOT NULL CONSTRAINT "DF_0cbca3fa0e36e6fa26e9a52389b" DEFAULT getdate(), "update_at" datetime2 NOT NULL CONSTRAINT "DF_ea264d58431d742f470c0403c3d" DEFAULT getdate(), "Hours" nvarchar(255) NOT NULL, "Quantity" int NOT NULL, "Price" int NOT NULL, "Invoice" nvarchar(255) NOT NULL, "productId" uniqueidentifier, "orderId" uniqueidentifier, CONSTRAINT "PK_d01158fe15b1ead5c26fd7f4e90" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "address_contact" ("id" uniqueidentifier NOT NULL CONSTRAINT "DF_c7080920da604275c6376958711" DEFAULT NEWSEQUENTIALID(), "createad_at" datetime2 NOT NULL CONSTRAINT "DF_354ad8ff4d625281e62638cbadd" DEFAULT getdate(), "update_at" datetime2 NOT NULL CONSTRAINT "DF_f1975ade4e1e2c9d58987c5cf19" DEFAULT getdate(), "Hours" nvarchar(255) NOT NULL, "Neighborhood" nvarchar(255) NOT NULL, "ZipCode" nvarchar(255) NOT NULL, "Telephone" nvarchar(255) NOT NULL, "Cellphone" nvarchar(255) NOT NULL, "Number" int NOT NULL, "State" nvarchar(255) NOT NULL, "Address" nvarchar(255) NOT NULL, "userId" uniqueidentifier, "commercialId" uniqueidentifier, CONSTRAINT "PK_c7080920da604275c6376958711" PRIMARY KEY ("id"))`);
